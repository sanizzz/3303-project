...
public class DroneStatusUpdate {
    ...
    public String toString() {
        return String.format("DroneStatus[drone=%d, state=%s, mission=%d, agent=%.1fL, battery=%.1fs, msg=%s]",
                droneId, droneState, missionId, remainingAgent, remainingBattery, message);
    }
}
